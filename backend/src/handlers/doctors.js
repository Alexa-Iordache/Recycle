...
let doctors = {
    ...
    addDoctor(req, res, next) {
        ...
        mysql.query(`INSERT INTO Doctors (MedicalSpecialityID, LastName, FirstName, SSN, 
    ...
    deleteDoctor(req, res, next) {
        ...
        console.log(id);
        mysql.query(`DELETE FROM Doctors D WHERE ((D.DoctorID = '${id}'));`, (err, result) => {
            if (err) {
                throw err;
            }
        });
    ...
    editDoctor(req, res, next) {
        ...
        mysql.query(`UPDATE Doctors
            SET MedicalSpecialityID = '${medicalSpeciality}', LastName = '${lastName}', 
